...
public class CsvFileReader {
    ...
    public List<? extends Product> parseProduct(List<String> br) throws  WrongCSVFileReadingException {
        List<? extends Product> products = new LinkedList<>();
        HEADERS = readHeader(br.get(0));
        br.stream().skip(1).map(x -> reader(x, HEADERS))
